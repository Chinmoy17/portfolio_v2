    ...
    <Section id="projects">
      ...
      <div className="flex snap-x snap-mandatory gap-5 overflow-x-auto pb-4 [scrollbar-width:thin]">
        {builtProjects.map((project) => (
          <article
            key={project.id}
            className="group flex w-[280px] shrink-0 snap-start flex-col justify-between rounded-2xl border border-border bg-surface p-6 transition-colors hover:border-accent-dim"
          >
            <div>
